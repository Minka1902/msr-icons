...
export function Folder2({ fillColor = '#000', backgroundColor, onHover, style }) {
    return (
        <BaseIcon width="20" height="20" fill={fillColor} viewBox="0 0 24 24" onMouseEnter={onHover} style={{ backgroundColor, ...style }}>
...
export function PythonFile({ className = "", color = '#fff', size = 24, onClick, ...props }) {
    return (
        <BaseIcon className={className} stroke='black' fill={color} width={size} height={size} viewBox="0 0 24 24" onClick={onClick} {...props}>
...
export function NodeJSFile({ className = "", color = '#fff', size = 24, onClick, ...props }) {
    return (
        <BaseIcon className={className} stroke='black' fill={color} width={size} height={size} viewBox="0 0 24 24" onClick={onClick} {...props}>
...
export function JSFile({ className = "", color = '#fff', size = 24, onClick, ...props }) {
    return (
        <BaseIcon className={className} stroke='black' fill={color} width={size} height={size} viewBox="0 0 24 24" onClick={onClick} {...props}>
...
export function TXT({ className = "", color = '#fff', size = 24, onClick, ...props }) {
    return (
        <BaseIcon className={className} stroke='black' strokeLinejoin="round" strokeWidth="1.5" fill={color} width={size} height={size} viewBox="0 0 24 24" onClick={onClick} {...props}>
            <path d="M5 19v3h14v-3"></path>
            <path d="M19 10V7l-4-5H5v8"></path>
            <path d="M14 2v5h5"></path>
            <path d="M8 6h2"></path>
...
export function Bin({ className = "", color = '#fff', size = 24, onClick, ...props }) {
    return (
        <BaseIcon className={className} stroke='green' fill={color} width={size} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" height={size} viewBox="0 0 24 24" onClick={onClick} {...props}>
...
export function FolderOpen2({ className = "", color = '#ffcd4d', size = 24, onClick, ...props }) {
    return (
        <BaseIcon className={className} stroke={color} fill={color} width={size} strokeLinejoin="round" height={size} viewBox="0 0 16 16" onClick={onClick} strokeWidth="0.5" {...props}>
            <g strokeWidth="0"></g>
...
export function FamilyGroup({ fillColor = '#fff', size = 24, onClick, backgroundColor, onHover, style }) {
    return (
...
export function BaseIconFile({ fillColor = "#F7931E", onClick, backgroundColor, onHover, style, strokeWidth }) {
    return (
        <BaseIcon stroke={fillColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth || "1.5"} viewBox="0 0 24 24" onClick={onClick} onMouseEnter={onHover} style={{ backgroundColor, ...style }}>
            <path fill="transparent" d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z" />
            <polyline fill="transparent" points="13 2 13 9 20 9" />
